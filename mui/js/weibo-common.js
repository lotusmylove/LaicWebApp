function initContent(url, id, styles, extras){
var defaultStyles = {
top: "46px",
bottom: "0px",
...
embed = plus.webview.create(url, id, defaultStyles,extras);
...
w.beginLoading = function(){
 
plus.nativeUI.showWaiting();
 
}
w.closeLoading = function(){
